...
`name` 不区分大小写，当前入口支持的名称包括 `ServerChanTurbo`、`PushDeer`、`TelegramBot`、`DingTalk`、`WxPusher`、`Mail`、`FeiShu`、`WorkWeixin`、`PushPlus`、`Showdoc`、`Xizhi`、`Discord`、`GoCqhttp`、`Qmsg`、`WorkWeixinBot`、`Chanify`、`Bark`、`GoogleChat`、`Push`、`Slack`、`Pushback`、`Zulip`、`RocketChat`、`Pushover`、`Iyuu`、`NotifyX`、`Ntfy`、`YiFengChuanHua`、`WPush`、`PushBullet`、`SimplePush`、`PushMe`、`QQBot`。
