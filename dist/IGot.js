...
var IGot = /*#__PURE__*/function () {
  function IGot(_ref) {
    var token = _ref.token,
      key = _ref.key,
      proxy = _ref.proxy;
    _classCallCheck(this, IGot);
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (sendOptions.extraOptions) {
                iGotOptions = _objectSpread(_objectSpread({}, iGotOptions), sendOptions.extraOptions);
              }
              axiosOptions = {
